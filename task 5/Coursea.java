...
public class Coursea{
    ...
    private static void initializeData() {
        ...
        courseDatabase.addCourse(new Course("CS101", "Intro to Computer Science", "Basic concepts of computer science", 3, Arrays.asList("Mon 9-11", "Wed 9-11")));
        courseDatabase.addCourse(new Course("MATH101", "Calculus I", "Introduction to calculus", 2, Arrays.asList("Tue 10-12", "Thu 10-12")));
        courseDatabase.addCourse(new Course("PHY101", "Physics I", "Basic principles of physics", 2, Arrays.asList("Mon 2-4", "Wed 2-4")));
